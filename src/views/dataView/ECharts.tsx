...
const Echarts: FC<IEChartsProps> = () => {
    ...
    useEffect(() => {
        ...
        // 第一个图
        let barCharts = echarts.init(
            document.querySelector("#barCharts") as HTMLDivElement
        );
        barCharts.setOption({
            title: {
                text: "柱状图实例",
        ...
        // 第二个图
        let lineCharts = echarts.init(
            document.querySelector("#lineCharts") as HTMLDivElement
        );
        let x = data.map((item) => {
            return item.x;
        });
        let xValue = data.map((item) => {
            return item.val;
        });
        ...
        // 第三个图
        let pictorialBarCharts = echarts.init(
            document.querySelector("#pictorialBarCharts") as HTMLDivElement
        );
        const pathSymbols = {
            reindeer:
        ...
        //   第四个图
        let AQICharts = echarts.init(
            document.querySelector("#AQICharts") as HTMLDivElement
        );
        const dataBJ = [
        ...
        window.addEventListener("resize", () => {
            ...
            pictorialBarCharts && pictorialBarCharts.resize();
            AQICharts && AQICharts.resize();
        });
    }, []);
